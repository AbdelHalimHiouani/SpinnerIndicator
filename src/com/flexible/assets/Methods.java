...
public class Methods {
    private static void actionSnapshot(AnchorPane root) {
        root.getScene().setOnKeyPressed(keyEvent -> {
            ...
            if (keyEvent.getCode().equals(KeyCode.P)) {
                ...
                try {
                    ImageIO.write(bufferedImage, "png", new FileOutputStream("C:\\Users\\sms-info\\Desktop\\Wallpapers Ai\\ai\\IO.png"));
                } catch (IOException e) {
